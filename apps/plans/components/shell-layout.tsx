...
// zones). Found live (2026-08-28, independent Phase 1 audit): apps/plans
// never rendered this at all — only apps/pay had it — so ElioPlans was
...
/** ElioPlans' copy of the shared shell layout — sidebar/header persist,
 * module content renders inside `children`. See MASTER_BUILD_GUIDE.md Step 1.7. */
export function ShellLayout({ activeId = "plans", practiceName, userEmail, isOwner, children }: ShellLayoutProps) {
    ...
    <div className="flex h-screen bg-(--color-bg)">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-16 shrink-0 items-center border-b border-(--color-border) px-6">
          <span className="text-body-sm font-medium text-(--color-text-secondary)">ELIO — ElioPlans</span>
        </header>
