...
ALTER TABLE "pay_payslip_entries" ADD COLUMN IF NOT EXISTS "therapyRatePerMinute" DECIMAL(10,4);
...
ALTER TABLE "pay_private_revenue_line_items" ADD COLUMN IF NOT EXISTS "flagged" BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE "pay_private_revenue_line_items" ADD COLUMN IF NOT EXISTS "flagReason" TEXT;
