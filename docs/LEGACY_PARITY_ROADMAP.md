...
| Y2.7 | **Dentist log import** | Google Sheets + CSV paste + compare (if client still uses logs) | **Shipped** — `dentist-log-import-panel.tsx` + compare API; Google Sheets stub until service account configured |
